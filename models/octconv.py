#######################################
# import from https://github.com/d-li14/octconv.pytorch
...
class OctaveConv(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, alpha_in=0.5, alpha_out=0.5, stride=1, padding=0, dilation=1,
        ...
        # self.downsample=nn.AdaptiveAvgPool2d((376,329))
        ...
        if x_l is not None:
            ...
            if self.is_dw:
                ...
                try:
                    ...
                    x_l2h = torch.nn.functional.pad(x_l2h, (0, 1), mode='constant', value=0.0)
                    x_h = x_l2h + x_h2h
